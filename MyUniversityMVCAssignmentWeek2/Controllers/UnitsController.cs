...
namespace MyUniversityMVCAssignmentWeek2.Controllers
{
    public class UnitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UnitName,UnitDescription")] Unit unit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UnitName,UnitDescription")] Unit unit)
        {
            if (ModelState.IsValid)
            {
