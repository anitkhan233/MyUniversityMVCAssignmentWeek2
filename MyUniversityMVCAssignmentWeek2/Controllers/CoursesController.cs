...
namespace MyUniversityMVCAssignmentWeek2.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CourseName,CourseDescription,CricosCode")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CourseName,CourseDescription,CricosCode")] Course course)
        {
            if (ModelState.IsValid)
            {
